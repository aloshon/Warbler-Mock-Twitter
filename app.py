...
def like_message(msg_id):
    ...
    if liked_message in g.user.likes:
        ...
        return redirect(f"/messages/liked/{g.user.id}")
...
def show_liked_messages(user_id):
    ...
    return render_template('users/liked.html', user=user, likes=user.likes)
...
def homepage():
    ...
    # make a list of the ids of the messages that will display on the homepage
    if g.user:
